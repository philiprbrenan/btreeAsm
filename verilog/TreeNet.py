...
if __name__ == "__main__":
  chip = Chip('TreeNet')                                                             # Create chip object.  The name is used to create the summary and mask image file
...
# chip.set('option', 'loglevel', 'error')                                       # Warnings and above
  ...
  chip.input('verilog/TreeNet.v')                                                              # Source code
# chip.input('/home/azureuser/btreeBlock/verilog/$project/$instance/siliconCompiler/memory.v'   ) # Memory black box
  chip.input('verilog/TreeNet.sdc')                                                              # Synopsys design constraints file
  chip.set('design', 'TreeNet')                                                      # Show the top most module
