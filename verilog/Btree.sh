...
mkdir -p results/Btree_2_4_32_32                                                                     # Results folder where the summary of the OpenRoad run will be saved
...
cp "verilog/build/$DESIGN/job0/$DESIGN.pkg.json" "results/Btree_2_4_32_32/Btree.json"                                # Copy results out of docker to remote system
cp "verilog/build/$DESIGN/job0/$DESIGN.png"      "results/Btree_2_4_32_32/Btree.png"
cp "verilog/build/$DESIGN/job0/job.log"          "results/Btree_2_4_32_32/Btree.log"
EOF
