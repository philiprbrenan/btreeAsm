...
mkdir -p results/find_Btree_10_16_16_16                                                                     # Results folder where the summary of the OpenRoad run will be saved
...
cp "verilog/build/$DESIGN/job0/$DESIGN.pkg.json" "results/find_Btree_10_16_16_16/Btree.json"                                # Copy results out of docker to remote system
cp "verilog/build/$DESIGN/job0/$DESIGN.png"      "results/find_Btree_10_16_16_16/Btree.png"
cp "verilog/build/$DESIGN/job0/job.log"          "results/find_Btree_10_16_16_16/Btree.log"
EOF
