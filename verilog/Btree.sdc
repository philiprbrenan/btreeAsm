...
set_input_delay -max 1 -clock clock [get_ports main_k_164]
set_input_delay -min 1 -clock clock [get_ports main_k_164]
set_input_delay -max 1 -clock clock [get_ports main_d_165]
set_input_delay -min 1 -clock clock [get_ports main_d_165]
