...
module TreeNet;                                                                      // Test bench for database on a chip
  ...
  (* nomem2reg *)
  reg [8-1:0] main_address_2[7];
  (* nomem2reg *)
  reg [8-1:0] main_addressMask_3[7];
  (* nomem2reg *)
  reg [1-1:0] main_messageUp_4[7];
  (* nomem2reg *)
  reg [1-1:0] main_messageDown_5[7];
  (* nomem2reg *)
  reg [1-1:0] main_messageDownPending_6[7];
  (* nomem2reg *)
  reg [16-1:0] main_MessageUpNumber_7[7];
  (* nomem2reg *)
  reg [8-1:0] main_MessageUpSource_8[7];
  (* nomem2reg *)
  reg [8-1:0] main_MessageUpTarget_9[7];
  (* nomem2reg *)
  reg [24-1:0] main_MessageUpText_10[7];
  (* nomem2reg *)
  reg [16-1:0] main_MessageDownNumber_11[7];
  (* nomem2reg *)
  reg [8-1:0] main_MessageDownSource_12[7];
  (* nomem2reg *)
  reg [8-1:0] main_MessageDownTarget_13[7];
  (* nomem2reg *)
  reg [24-1:0] main_MessageDownText_14[7];
  (* nomem2reg *)
  reg [16-1:0] main_MessageDownPendingNumber_15[7];
  (* nomem2reg *)
  reg [8-1:0] main_MessageDownPendingSource_16[7];
  (* nomem2reg *)
  reg [8-1:0] main_MessageDownPendingTarget_17[7];
  (* nomem2reg *)
  reg [24-1:0] main_MessageDownPendingText_18[7];
    ...
    if (reset) begin
      ...
      if (processCurrent == 0) begin
        case(main_pc)
            ...
            case (main_pc)
              0: begin
                begin
                  ...
                  $fdisplay(f, "Location: Chip.java:0888:<init>|  Chip.java:1721:<init>|  Chip.java:1720:Zero|  TreeNet.java:0122:<init>|  TreeNet.java:0069:<init>|  TreeNet.java:1002:test_oneV|  TreeNet.java:1771:newTests|  TreeNet.java:1777:main|");
                  $fclose(f);
                end
              end
            endcase
            ...
            case (main_pc)
              1: begin
                begin
                  integer f;
                  f = $fopen("verilog/trace_verilog.txt", "a");
                  $fdisplay(f, "Location: Chip.java:0888:<init>|  Chip.java:1226:<init>|  Chip.java:1225:RegisterSet|  TreeNet.java:0495:addressPath|  TreeNet.java:0124:<init>|  TreeNet.java:0069:<init>|  TreeNet.java:1002:test_oneV|  TreeNet.java:1771:newTests|  TreeNet.java:1777:main|");
                  $fclose(f);
                end
              end
            endcase
            ...
            case (main_pc)
              2: begin
                begin
                  integer f;
                  f = $fopen("verilog/trace_verilog.txt", "a");
                  $fdisplay(f, "Location: Chip.java:0888:<init>|  Chip.java:1226:<init>|  Chip.java:1225:RegisterSet|  TreeNet.java:0496:addressPath|  TreeNet.java:0124:<init>|  TreeNet.java:0069:<init>|  TreeNet.java:1002:test_oneV|  TreeNet.java:1771:newTests|  TreeNet.java:1777:main|");
                  $fclose(f);
                end
              end
            endcase
          ...
          15: begin
            if (main_messageUp_4[5]) begin
              main_putMessage_0                <= 0;
            end
            else begin
              main_messageUp_4[5]              <= 1;
              main_MessageUpNumber_7[5]        <= main_MessageNumber_20;
              main_MessageUpSource_8[5]        <= 5;
              main_MessageUpTarget_9[5]        <= 3;
              main_MessageUpText_10[5]         <= 1111;
            ...
            case (main_pc)
              15: begin
                begin
                  integer f;
                  f = $fopen("verilog/trace_verilog.txt", "a");
                  $fdisplay(f, "Location: Chip.java:0888:<init>|  TreeNet.java:0356:<init>|  TreeNet.java:0355:PutMessage|  TreeNet.java:1005:test_oneV|  TreeNet.java:1771:newTests|  TreeNet.java:1777:main|");
                  $fclose(f);
                end
              end
            endcase
            ...
            case (main_pc)
              16: begin
                begin
                  integer f;
                  f = $fopen("verilog/trace_verilog.txt", "a");
                  $fdisplay(f, "Location: Chip.java:0888:<init>|  TreeNet.java:0989:<init>|  TreeNet.java:0988:test_transmission|  TreeNet.java:1007:test_oneV|  TreeNet.java:1771:newTests|  TreeNet.java:1777:main|");
                  $fclose(f);
                end
              end
              26: begin
            ...
            case (main_pc)
              17: begin
                begin
                  integer f;
                  f = $fopen("verilog/trace_verilog.txt", "a");
                  $fdisplay(f, "Location: Chip.java:0888:<init>|  TreeNet.java:0208:<init>|  TreeNet.java:0207:Transmit|  TreeNet.java:0993:test_transmission|  TreeNet.java:1007:test_oneV|  TreeNet.java:1771:newTests|  TreeNet.java:1777:main|");
                  $fclose(f);
                end
              end
              27: begin
            ...
            case (main_pc)
              18: begin
                begin
                  integer f;
                  f = $fopen("verilog/trace_verilog.txt", "a");
                  $fdisplay(f, "Location: Chip.java:0888:<init>|  TreeNet.java:0216:<init>|  TreeNet.java:0215:Transmit|  TreeNet.java:0993:test_transmission|  TreeNet.java:1007:test_oneV|  TreeNet.java:1771:newTests|  TreeNet.java:1777:main|");
                  $fclose(f);
                end
              end
              28: begin
          ...
          19, 29, 39, 49: begin
            main_messageDown_5[0]            <= main_messageUp_4[0];
            main_MessageDownNumber_11[0]     <= main_MessageUpNumber_7[0];
            main_MessageDownSource_12[0]     <= main_MessageUpSource_8[0];
            main_MessageDownTarget_13[0]     <= main_MessageUpTarget_9[0];
            main_MessageDownText_14[0]       <= main_MessageUpText_10[0];
            main_pc          <= main_pc + 1;
            case (main_pc)
              19: begin
                begin
                  integer f;
                  f = $fopen("verilog/trace_verilog.txt", "a");
                  $fdisplay(f, "Location: Chip.java:0888:<init>|  TreeNet.java:0226:<init>|  TreeNet.java:0225:Transmit|  TreeNet.java:0993:test_transmission|  TreeNet.java:1007:test_oneV|  TreeNet.java:1771:newTests|  TreeNet.java:1777:main|");
                  $fclose(f);
                end
              end
              29: begin
            ...
            case (main_pc)
              20: begin
                begin
                  integer f;
                  f = $fopen("verilog/trace_verilog.txt", "a");
                  $fdisplay(f, "Location: Chip.java:0888:<init>|  TreeNet.java:0247:<init>|  TreeNet.java:0246:Transmit|  TreeNet.java:0993:test_transmission|  TreeNet.java:1007:test_oneV|  TreeNet.java:1771:newTests|  TreeNet.java:1777:main|");
                  $fclose(f);
                end
              end
              30: begin
          ...
          21, 31, 41, 51: begin
            if (main_messageDown_5[0] && !main_messageDown_5[1] && ((main_address_2[1] & main_addressMask_3[1]) == (main_address_2[main_MessageDownTarget_13[0]] & main_addressMask_3[1]))) begin
              ...
              if (main_messageUp_4[0] && ((main_address_2[1] & main_addressMask_3[1]) == (main_address_2[main_MessageUpTarget_9[0]] & main_addressMask_3[1]))) begin
                main_messageDownPending_6[1]     <= 1;
                main_MessageDownPendingNumber_15[1]              <= main_MessageUpNumber_7[0];
                main_MessageDownPendingSource_16[1]              <= main_MessageUpSource_8[0];
                main_MessageDownPendingTarget_17[1]              <= main_MessageUpTarget_9[0];
                main_MessageDownPendingText_18[1]                <= main_MessageUpText_10[0];
              end
            end
            if (main_messageDown_5[0] && !main_messageDown_5[2] && ((main_address_2[2] & main_addressMask_3[2]) == (main_address_2[main_MessageDownTarget_13[0]] & main_addressMask_3[2]))) begin
              ...
              if (main_messageUp_4[0] && ((main_address_2[2] & main_addressMask_3[2]) == (main_address_2[main_MessageUpTarget_9[0]] & main_addressMask_3[2]))) begin
                main_messageDownPending_6[2]     <= 1;
                main_MessageDownPendingNumber_15[2]              <= main_MessageUpNumber_7[0];
                main_MessageDownPendingSource_16[2]              <= main_MessageUpSource_8[0];
                main_MessageDownPendingTarget_17[2]              <= main_MessageUpTarget_9[0];
                main_MessageDownPendingText_18[2]                <= main_MessageUpText_10[0];
              end
            end
            if (main_messageDown_5[1] && !main_messageDown_5[3] && ((main_address_2[3] & main_addressMask_3[3]) == (main_address_2[main_MessageDownTarget_13[1]] & main_addressMask_3[3]))) begin
              ...
              if (main_messageUp_4[1] && ((main_address_2[3] & main_addressMask_3[3]) == (main_address_2[main_MessageUpTarget_9[1]] & main_addressMask_3[3]))) begin
                main_messageDownPending_6[3]     <= 1;
                main_MessageDownPendingNumber_15[3]              <= main_MessageUpNumber_7[1];
                main_MessageDownPendingSource_16[3]              <= main_MessageUpSource_8[1];
                main_MessageDownPendingTarget_17[3]              <= main_MessageUpTarget_9[1];
                main_MessageDownPendingText_18[3]                <= main_MessageUpText_10[1];
              end
            end
            if (main_messageDown_5[1] && !main_messageDown_5[4] && ((main_address_2[4] & main_addressMask_3[4]) == (main_address_2[main_MessageDownTarget_13[1]] & main_addressMask_3[4]))) begin
              ...
              if (main_messageUp_4[1] && ((main_address_2[4] & main_addressMask_3[4]) == (main_address_2[main_MessageUpTarget_9[1]] & main_addressMask_3[4]))) begin
                main_messageDownPending_6[4]     <= 1;
                main_MessageDownPendingNumber_15[4]              <= main_MessageUpNumber_7[1];
                main_MessageDownPendingSource_16[4]              <= main_MessageUpSource_8[1];
                main_MessageDownPendingTarget_17[4]              <= main_MessageUpTarget_9[1];
                main_MessageDownPendingText_18[4]                <= main_MessageUpText_10[1];
              end
            end
            if (main_messageDown_5[2] && !main_messageDown_5[5] && ((main_address_2[5] & main_addressMask_3[5]) == (main_address_2[main_MessageDownTarget_13[2]] & main_addressMask_3[5]))) begin
              ...
              if (main_messageUp_4[2] && ((main_address_2[5] & main_addressMask_3[5]) == (main_address_2[main_MessageUpTarget_9[2]] & main_addressMask_3[5]))) begin
                main_messageDownPending_6[5]     <= 1;
                main_MessageDownPendingNumber_15[5]              <= main_MessageUpNumber_7[2];
                main_MessageDownPendingSource_16[5]              <= main_MessageUpSource_8[2];
                main_MessageDownPendingTarget_17[5]              <= main_MessageUpTarget_9[2];
                main_MessageDownPendingText_18[5]                <= main_MessageUpText_10[2];
              end
            end
            if (main_messageDown_5[2] && !main_messageDown_5[6] && ((main_address_2[6] & main_addressMask_3[6]) == (main_address_2[main_MessageDownTarget_13[2]] & main_addressMask_3[6]))) begin
              ...
              if (main_messageUp_4[2] && ((main_address_2[6] & main_addressMask_3[6]) == (main_address_2[main_MessageUpTarget_9[2]] & main_addressMask_3[6]))) begin
                main_messageDownPending_6[6]     <= 1;
                main_MessageDownPendingNumber_15[6]              <= main_MessageUpNumber_7[2];
                main_MessageDownPendingSource_16[6]              <= main_MessageUpSource_8[2];
                main_MessageDownPendingTarget_17[6]              <= main_MessageUpTarget_9[2];
                main_MessageDownPendingText_18[6]                <= main_MessageUpText_10[2];
              end
            end
            main_pc          <= main_pc + 1;
            case (main_pc)
              21: begin
                begin
                  integer f;
                  f = $fopen("verilog/trace_verilog.txt", "a");
                  $fdisplay(f, "Location: Chip.java:0888:<init>|  TreeNet.java:0256:<init>|  TreeNet.java:0255:Transmit|  TreeNet.java:0993:test_transmission|  TreeNet.java:1007:test_oneV|  TreeNet.java:1771:newTests|  TreeNet.java:1777:main|");
                  $fclose(f);
                end
              end
              31: begin
            ...
            case (main_pc)
              22: begin
                begin
                  integer f;
                  f = $fopen("verilog/trace_verilog.txt", "a");
                  $fdisplay(f, "Location: Chip.java:0888:<init>|  TreeNet.java:0264:<init>|  TreeNet.java:0263:Transmit|  TreeNet.java:0993:test_transmission|  TreeNet.java:1007:test_oneV|  TreeNet.java:1771:newTests|  TreeNet.java:1777:main|");
                  $fclose(f);
                end
              end
              32: begin
            ...
            case (main_pc)
              23: begin
                begin
                  integer f;
                  f = $fopen("verilog/trace_verilog.txt", "a");
                  $fdisplay(f, "Location: Chip.java:0888:<init>|  TreeNet.java:0272:<init>|  TreeNet.java:0271:Transmit|  TreeNet.java:0993:test_transmission|  TreeNet.java:1007:test_oneV|  TreeNet.java:1771:newTests|  TreeNet.java:1777:main|");
                  $fclose(f);
                end
              end
              33: begin
          ...
          24, 34, 44, 54: begin
            if ((main_messageDown_5[3] && main_messageUp_4[1] && main_MessageDownNumber_11[3] == main_MessageUpNumber_7[1]) ||(main_messageDown_5[4] && main_messageUp_4[1] && main_MessageDownNumber_11[4] == main_MessageUpNumber_7[1])) begin
              main_messageUp_4[1]              <= 0;
            end
            if ((main_messageDown_5[5] && main_messageUp_4[2] && main_MessageDownNumber_11[5] == main_MessageUpNumber_7[2]) ||(main_messageDown_5[6] && main_messageUp_4[2] && main_MessageDownNumber_11[6] == main_MessageUpNumber_7[2])) begin
              main_messageUp_4[2]              <= 0;
            end
            main_pc          <= main_pc + 1;
            case (main_pc)
              24: begin
                begin
                  integer f;
                  f = $fopen("verilog/trace_verilog.txt", "a");
                  $fdisplay(f, "Location: Chip.java:0888:<init>|  TreeNet.java:0281:<init>|  TreeNet.java:0280:Transmit|  TreeNet.java:0993:test_transmission|  TreeNet.java:1007:test_oneV|  TreeNet.java:1771:newTests|  TreeNet.java:1777:main|");
                  $fclose(f);
                end
              end
              34: begin
            ...
            case (main_pc)
              25: begin
                begin
                  integer f;
                  f = $fopen("verilog/trace_verilog.txt", "a");
                  $fdisplay(f, "Location: Chip.java:0888:<init>|  Chip.java:1795:<init>|  Chip.java:1794:Not|  TreeNet.java:0289:Transmit|  TreeNet.java:0993:test_transmission|  TreeNet.java:1007:test_oneV|  TreeNet.java:1771:newTests|  TreeNet.java:1777:main|");
                  $fclose(f);
                end
              end
              35: begin
  ...
  task chipPrint;
    begin
      ...
      $fwrite(o, "    Process: %1d - %-21s instructions: %1d, pc: %1d, rc: %1d\n", 0, "main", 56, main_pc, main_returnCode);
      $fwrite(o, "      Registers :\n");
