...
module Btree;                                                                      // Test bench for database on a chip
  ...
  reg [1-1:0] main_index_0;
  reg [4-1:0] main_size_1;
  reg [1-1:0] main_isLeaf_2;
  reg [1-1:0] main_nextFree_3;
  (* nomem2reg *)
  ...
  reg [0-1:0] main_stuckKeys_1_index_8;
  reg [0-1:0] main_stuckKeys_2_index_9;
  (* nomem2reg *)
  reg [8-1:0] main_stuckKeys_2_value_10[8];
  reg [0-1:0] main_stuckData_3_index_11;
  reg [0-1:0] main_stuckData_4_index_12;
  (* nomem2reg *)
  reg [8-1:0] main_stuckData_4_value_13[8];
  reg [0-1:0] main_stuckSize_5_index_14;
  reg [0-1:0] main_stuckSize_6_index_15;
  (* nomem2reg *)
  reg [4-1:0] main_stuckSize_6_value_16[1];
  reg [0-1:0] main_stuckIsLeaf_7_index_17;
  reg [0-1:0] main_stuckIsLeaf_8_index_18;
  (* nomem2reg *)
    ...
    if (step < 0) begin
      ...
      case(main_pc)
          ...
          case (main_pc)
            0: begin
              begin
                ...
                $fdisplay(f, "Location: Chip.java:0575:<init>|  Chip.java:0823:<init>|  Chip.java:0822:RegisterSet|  Btree.java:2749:test_copy|  Btree.java:7003:newTests|  Btree.java:7009:main|");
                $fclose(f);
              end
            end
          endcase
          ...
          case (main_pc)
            1: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:0575:<init>|  Chip.java:1169:<init>|  Chip.java:1168:Zero|  Btree.java:0318:stuckGetRoot|  Btree.java:2750:test_copy|  Btree.java:7003:newTests|  Btree.java:7009:main|");
                $fclose(f);
              end
            end
          endcase
          ...
          case (main_pc)
            2: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:0575:<init>|  Btree.java:0324:<init>|  Btree.java:0323:stuckGet|  Btree.java:0319:stuckGetRoot|  Btree.java:2750:test_copy|  Btree.java:7003:newTests|  Btree.java:7009:main|");
                $fclose(f);
              end
            end
          endcase
          ...
          case (main_pc)
            3: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:1866:<init>|  Chip.java:1865:waitResultOfTransaction|  Btree.java:0337:stuckGet|  Btree.java:0319:stuckGetRoot|  Btree.java:2750:test_copy|  Btree.java:7003:newTests|  Btree.java:7009:main|");
                $fclose(f);
              end
            end
          endcase
          ...
          case (main_pc)
            4: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:1866:<init>|  Chip.java:1865:waitResultOfTransaction|  Btree.java:0338:stuckGet|  Btree.java:0319:stuckGetRoot|  Btree.java:2750:test_copy|  Btree.java:7003:newTests|  Btree.java:7009:main|");
                $fclose(f);
              end
            end
          endcase
          ...
          case (main_pc)
            5: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:1866:<init>|  Chip.java:1865:waitResultOfTransaction|  Btree.java:0339:stuckGet|  Btree.java:0319:stuckGetRoot|  Btree.java:2750:test_copy|  Btree.java:7003:newTests|  Btree.java:7009:main|");
                $fclose(f);
              end
            end
          endcase
          ...
          case (main_pc)
            6: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:1866:<init>|  Chip.java:1865:waitResultOfTransaction|  Btree.java:0340:stuckGet|  Btree.java:0319:stuckGetRoot|  Btree.java:2750:test_copy|  Btree.java:7003:newTests|  Btree.java:7009:main|");
                $fclose(f);
              end
            end
          endcase
          ...
          case (main_pc)
            7: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:0575:<init>|  Btree.java:0343:<init>|  Btree.java:0342:stuckGet|  Btree.java:0319:stuckGetRoot|  Btree.java:2750:test_copy|  Btree.java:7003:newTests|  Btree.java:7009:main|");
                $fclose(f);
              end
            end
          endcase
        ...
        8: begin
          begin
            for(main_memory_index = 0; main_memory_index < 8; main_memory_index = main_memory_index + 1) begin
              main_Keys_171[main_memory_index] <= main_Keys_156[main_memory_index];
            end
          end
          begin
            for(main_memory_index = 0; main_memory_index < 8; main_memory_index = main_memory_index + 1) begin
              main_Data_174[main_memory_index] <= main_Data_159[main_memory_index];
            end
          end
          main_size_168 <= main_size_153;
          main_isLeaf_169 <= main_isLeaf_154;
          main_pc <= main_pc + 1;
          case (main_pc)
            8: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:0575:<init>|  Btree.java:0448:<init>|  Btree.java:0447:Copy|  Btree.java:2751:test_copy|  Btree.java:7003:newTests|  Btree.java:7009:main|");
                $fclose(f);
              end
            end
          endcase
        ...
        9: begin
          if (main_delta_182 & 8) begin
            for (main_memory_index = 8-1; main_memory_index >= 8; main_memory_index = main_memory_index -1) begin
              main_Keys_171[main_memory_index] <= main_Keys_171[main_memory_index-8];
              main_Data_174[main_memory_index] <= main_Data_174[main_memory_index-8];
            end
            for (main_memory_index = 0; main_memory_index < 8; main_memory_index = main_memory_index+1) begin
              main_Keys_171[main_memory_index] <= 0;
              main_Data_174[main_memory_index] <= 0;
          ...
          case (main_pc)
            9: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:0575:<init>|  Btree.java:0573:<init>|  Btree.java:0572:CopyUp|  Btree.java:2752:test_copy|  Btree.java:7003:newTests|  Btree.java:7009:main|");
                $fclose(f);
              end
            end
          endcase
        ...
        10: begin
          if (main_delta_182 & 4) begin
            for (main_memory_index = 8-1; main_memory_index >= 4; main_memory_index = main_memory_index -1) begin
              main_Keys_171[main_memory_index] <= main_Keys_171[main_memory_index-4];
              main_Data_174[main_memory_index] <= main_Data_174[main_memory_index-4];
            end
        ...
        11: begin
          if (main_delta_182 & 2) begin
            for (main_memory_index = 8-1; main_memory_index >= 2; main_memory_index = main_memory_index -1) begin
              main_Keys_171[main_memory_index] <= main_Keys_171[main_memory_index-2];
              main_Data_174[main_memory_index] <= main_Data_174[main_memory_index-2];
            end
  ...
  always @ (posedge clock) begin
    if (step < 0) begin
      ...
      for(stuckIsFree_memory_index = 0; stuckIsFree_memory_index < 1; stuckIsFree_memory_index = stuckIsFree_memory_index + 1) begin
        stuckIsFree_memory[stuckIsFree_memory_index] <= 0+stuckIsFree_memory_index;
      end
    end
  ...
  always @ (posedge clock) begin
    if (step < 0) begin
      ...
      for(freeNext_memory_index = 0; freeNext_memory_index < 1; freeNext_memory_index = freeNext_memory_index + 1) begin
        freeNext_memory[freeNext_memory_index] <= 0+freeNext_memory_index;
      end
    end
  ...
  always @ (posedge clock) begin
    if (step < 0) begin
      ...
      for(stuckSize_memory_index = 0; stuckSize_memory_index < 1; stuckSize_memory_index = stuckSize_memory_index + 1) begin
        stuckSize_memory[stuckSize_memory_index] <= 4+stuckSize_memory_index;
      end
    end
  ...
  always @ (posedge clock) begin
    if (step < 0) begin
      ...
      for(stuckKeys_memory_index = 1; stuckKeys_memory_index < 2; stuckKeys_memory_index = stuckKeys_memory_index + 1) begin
        stuckKeys_memory[stuckKeys_memory_index] <= 3+stuckKeys_memory_index;
      end
      for(stuckKeys_memory_index = 2; stuckKeys_memory_index < 3; stuckKeys_memory_index = stuckKeys_memory_index + 1) begin
        stuckKeys_memory[stuckKeys_memory_index] <= 4+stuckKeys_memory_index;
      end
      for(stuckKeys_memory_index = 3; stuckKeys_memory_index < 4; stuckKeys_memory_index = stuckKeys_memory_index + 1) begin
        stuckKeys_memory[stuckKeys_memory_index] <= 5+stuckKeys_memory_index;
      end
      for(stuckKeys_memory_index = 4; stuckKeys_memory_index < 5; stuckKeys_memory_index = stuckKeys_memory_index + 1) begin
        stuckKeys_memory[stuckKeys_memory_index] <= 6+stuckKeys_memory_index;
      end
      for(stuckKeys_memory_index = 5; stuckKeys_memory_index < 6; stuckKeys_memory_index = stuckKeys_memory_index + 1) begin
      ...
      for(stuckKeys_memory_index = 6; stuckKeys_memory_index < 7; stuckKeys_memory_index = stuckKeys_memory_index + 1) begin
        stuckKeys_memory[stuckKeys_memory_index] <= 8+stuckKeys_memory_index;
      end
      for(stuckKeys_memory_index = 7; stuckKeys_memory_index < 8; stuckKeys_memory_index = stuckKeys_memory_index + 1) begin
        stuckKeys_memory[stuckKeys_memory_index] <= 9+stuckKeys_memory_index;
      end
    end
  ...
  always @ (posedge clock) begin
    if (step < 0) begin
      ...
      for(stuckData_memory_index = 0; stuckData_memory_index < 1; stuckData_memory_index = stuckData_memory_index + 1) begin
        stuckData_memory[stuckData_memory_index] <= 3+stuckData_memory_index;
      end
      for(stuckData_memory_index = 1; stuckData_memory_index < 2; stuckData_memory_index = stuckData_memory_index + 1) begin
        stuckData_memory[stuckData_memory_index] <= 4+stuckData_memory_index;
      end
      for(stuckData_memory_index = 2; stuckData_memory_index < 3; stuckData_memory_index = stuckData_memory_index + 1) begin
        stuckData_memory[stuckData_memory_index] <= 5+stuckData_memory_index;
      end
      for(stuckData_memory_index = 3; stuckData_memory_index < 4; stuckData_memory_index = stuckData_memory_index + 1) begin
      ...
      for(stuckData_memory_index = 5; stuckData_memory_index < 6; stuckData_memory_index = stuckData_memory_index + 1) begin
        stuckData_memory[stuckData_memory_index] <= 8+stuckData_memory_index;
      end
      for(stuckData_memory_index = 6; stuckData_memory_index < 7; stuckData_memory_index = stuckData_memory_index + 1) begin
        stuckData_memory[stuckData_memory_index] <= 9+stuckData_memory_index;
      end
