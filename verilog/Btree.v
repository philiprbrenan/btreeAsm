...
module Btree;                                                                      // Test bench for database on a chip
  ...
  reg [3-1:0] main_size_153;
  reg [1-1:0] main_isLeaf_154;
  reg [4-1:0] main_nextFree_155;
  (* nomem2reg *)
  reg [8-1:0] main_Keys_156[4];
  (* nomem2reg *)
  reg [1-1:0] main_Compares_157[4];
  (* nomem2reg *)
  reg [3-1:0] main_Collapse_158[4];
  (* nomem2reg *)
  reg [8-1:0] main_Data_159[4];
  ...
  reg [3-1:0] main_StuckIndex_165;
  reg [1-1:0] main_MergeSuccess_166;
  reg [8-1:0] main_d_167;
  reg [4-1:0] main_n_168;
  reg [4-1:0] main_index_169;
  reg [3-1:0] main_size_170;
  reg [1-1:0] main_isLeaf_171;
  reg [4-1:0] main_nextFree_172;
  (* nomem2reg *)
  reg [8-1:0] main_Keys_173[4];
  (* nomem2reg *)
  reg [1-1:0] main_Compares_174[4];
  (* nomem2reg *)
  reg [3-1:0] main_Collapse_175[4];
  (* nomem2reg *)
  reg [8-1:0] main_Data_176[4];
  ...
  reg [3-1:0] main_StuckIndex_182;
  reg [1-1:0] main_MergeSuccess_183;
  reg [8-1:0] main_d_184;
  reg [4-1:0] main_n_185;
  reg [4-1:0] main_index_186;
  reg [3-1:0] main_size_187;
  reg [1-1:0] main_isLeaf_188;
  reg [4-1:0] main_nextFree_189;
  (* nomem2reg *)
  reg [8-1:0] main_Keys_190[4];
  (* nomem2reg *)
  reg [1-1:0] main_Compares_191[4];
  (* nomem2reg *)
  reg [3-1:0] main_Collapse_192[4];
  (* nomem2reg *)
  reg [8-1:0] main_Data_193[4];
  ...
  reg [3-1:0] main_size_204;
  reg [1-1:0] main_isLeaf_205;
  reg [4-1:0] main_nextFree_206;
  (* nomem2reg *)
  reg [8-1:0] main_Keys_207[4];
  (* nomem2reg *)
  reg [1-1:0] main_Compares_208[4];
  (* nomem2reg *)
  reg [3-1:0] main_Collapse_209[4];
  (* nomem2reg *)
  reg [8-1:0] main_Data_210[4];
  ...
  reg [3-1:0] main_StuckIndex_216;
  reg [1-1:0] main_MergeSuccess_217;
  reg [4-1:0] main_index_218;
  reg [3-1:0] main_size_219;
  reg [1-1:0] main_isLeaf_220;
  reg [4-1:0] main_nextFree_221;
  (* nomem2reg *)
  reg [8-1:0] main_Keys_222[4];
  (* nomem2reg *)
  reg [1-1:0] main_Compares_223[4];
  (* nomem2reg *)
  reg [3-1:0] main_Collapse_224[4];
  (* nomem2reg *)
  reg [8-1:0] main_Data_225[4];
  ...
  reg [3-1:0] main_size_234;
  reg [1-1:0] main_isLeaf_235;
  reg [4-1:0] main_nextFree_236;
  (* nomem2reg *)
  reg [8-1:0] main_Keys_237[4];
  (* nomem2reg *)
  reg [1-1:0] main_Compares_238[4];
  (* nomem2reg *)
  reg [3-1:0] main_Collapse_239[4];
  (* nomem2reg *)
  reg [8-1:0] main_Data_240[4];
  ...
  reg [3-1:0] main_StuckIndex_246;
  reg [1-1:0] main_MergeSuccess_247;
  reg [8-1:0] main_Left_248;
  reg [8-1:0] main_Right_249;
  reg [8-1:0] main_k_250;
  reg [8-1:0] main_d_251;
  integer main_pc;
  integer main_stop;
  ...
  always @ (posedge clock) begin
    if (step < 0) begin
      ...
      case(main_pc)
          ...
          case (main_pc)
            0: begin
              begin
                ...
                $fdisplay(f, "Location: Chip.java:0575:<init>|  Chip.java:1174:<init>|  Chip.java:1173:Zero|  Btree.java:0318:stuckGetRoot|  Btree.java:4141:test_splitLowButOne|  Btree.java:7114:newTests|  Btree.java:7120:main|");
                $fclose(f);
              end
            end
          endcase
          ...
          case (main_pc)
            1: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:0575:<init>|  Btree.java:0324:<init>|  Btree.java:0323:stuckGet|  Btree.java:0319:stuckGetRoot|  Btree.java:4141:test_splitLowButOne|  Btree.java:7114:newTests|  Btree.java:7120:main|");
                $fclose(f);
              end
            end
          endcase
          ...
          case (main_pc)
            2: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:1875:<init>|  Chip.java:1874:waitResultOfTransaction|  Btree.java:0337:stuckGet|  Btree.java:0319:stuckGetRoot|  Btree.java:4141:test_splitLowButOne|  Btree.java:7114:newTests|  Btree.java:7120:main|");
                $fclose(f);
              end
            end
            25: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:1875:<init>|  Chip.java:1874:waitResultOfTransaction|  Btree.java:0337:stuckGet|  Btree.java:0314:stuckGet|  Btree.java:4151:test_splitLowButOne|  Btree.java:7114:newTests|  Btree.java:7120:main|");
                $fclose(f);
              end
            end
            32: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:1875:<init>|  Chip.java:1874:waitResultOfTransaction|  Btree.java:0337:stuckGet|  Btree.java:0314:stuckGet|  Btree.java:4152:test_splitLowButOne|  Btree.java:7114:newTests|  Btree.java:7120:main|");
                $fclose(f);
              end
            end
          endcase
          ...
          case (main_pc)
            3: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:1875:<init>|  Chip.java:1874:waitResultOfTransaction|  Btree.java:0338:stuckGet|  Btree.java:0319:stuckGetRoot|  Btree.java:4141:test_splitLowButOne|  Btree.java:7114:newTests|  Btree.java:7120:main|");
                $fclose(f);
              end
            end
            26: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:1875:<init>|  Chip.java:1874:waitResultOfTransaction|  Btree.java:0338:stuckGet|  Btree.java:0314:stuckGet|  Btree.java:4151:test_splitLowButOne|  Btree.java:7114:newTests|  Btree.java:7120:main|");
                $fclose(f);
              end
            end
            33: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:1875:<init>|  Chip.java:1874:waitResultOfTransaction|  Btree.java:0338:stuckGet|  Btree.java:0314:stuckGet|  Btree.java:4152:test_splitLowButOne|  Btree.java:7114:newTests|  Btree.java:7120:main|");
                $fclose(f);
              end
            end
          endcase
          ...
          case (main_pc)
            4: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:1875:<init>|  Chip.java:1874:waitResultOfTransaction|  Btree.java:0339:stuckGet|  Btree.java:0319:stuckGetRoot|  Btree.java:4141:test_splitLowButOne|  Btree.java:7114:newTests|  Btree.java:7120:main|");
                $fclose(f);
              end
            end
            27: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:1875:<init>|  Chip.java:1874:waitResultOfTransaction|  Btree.java:0339:stuckGet|  Btree.java:0314:stuckGet|  Btree.java:4151:test_splitLowButOne|  Btree.java:7114:newTests|  Btree.java:7120:main|");
                $fclose(f);
              end
            end
            34: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:1875:<init>|  Chip.java:1874:waitResultOfTransaction|  Btree.java:0339:stuckGet|  Btree.java:0314:stuckGet|  Btree.java:4152:test_splitLowButOne|  Btree.java:7114:newTests|  Btree.java:7120:main|");
                $fclose(f);
              end
            end
          endcase
          ...
          case (main_pc)
            5: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:1875:<init>|  Chip.java:1874:waitResultOfTransaction|  Btree.java:0340:stuckGet|  Btree.java:0319:stuckGetRoot|  Btree.java:4141:test_splitLowButOne|  Btree.java:7114:newTests|  Btree.java:7120:main|");
                $fclose(f);
              end
            end
            28: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:1875:<init>|  Chip.java:1874:waitResultOfTransaction|  Btree.java:0340:stuckGet|  Btree.java:0314:stuckGet|  Btree.java:4151:test_splitLowButOne|  Btree.java:7114:newTests|  Btree.java:7120:main|");
                $fclose(f);
              end
            end
            35: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:1875:<init>|  Chip.java:1874:waitResultOfTransaction|  Btree.java:0340:stuckGet|  Btree.java:0314:stuckGet|  Btree.java:4152:test_splitLowButOne|  Btree.java:7114:newTests|  Btree.java:7120:main|");
                $fclose(f);
              end
            end
          endcase
          ...
          case (main_pc)
            6: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:0575:<init>|  Btree.java:0343:<init>|  Btree.java:0342:stuckGet|  Btree.java:0319:stuckGetRoot|  Btree.java:4141:test_splitLowButOne|  Btree.java:7114:newTests|  Btree.java:7120:main|");
                $fclose(f);
              end
            end
          endcase
          ...
          case (main_pc)
            7: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:0575:<init>|  Chip.java:1174:<init>|  Chip.java:1173:Zero|  Btree.java:4142:test_splitLowButOne|  Btree.java:7114:newTests|  Btree.java:7120:main|");
                $fclose(f);
              end
            end
          endcase
          ...
          case (main_pc)
            8: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:0575:<init>|  Chip.java:0828:<init>|  Chip.java:0827:RegisterSet|  Btree.java:4146:test_splitLowButOne|  Btree.java:7114:newTests|  Btree.java:7120:main|");
                $fclose(f);
              end
            end
          endcase
        ...
        10, 13, 16, 19: begin
          main_Keys_207[main_size_204] <= main_k_250;
          main_Data_210[main_size_204] <= main_d_251;
          ...
          case (main_pc)
            10: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:0575:<init>|  Btree.java:0647:<init>|  Btree.java:0646:Push|  Btree.java:4146:test_splitLowButOne|  Btree.java:7114:newTests|  Btree.java:7120:main|");
                $fclose(f);
              end
            end
            13: begin
          ...
          case (main_pc)
            20: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:0575:<init>|  Chip.java:0828:<init>|  Chip.java:0827:RegisterSet|  Btree.java:4149:test_splitLowButOne|  Btree.java:7114:newTests|  Btree.java:7120:main|");
                $fclose(f);
              end
            end
          endcase
        ...
        22: begin
          main_Key_212 <= main_Keys_207[main_size_204+-1];
          main_Data_214 <= main_Data_210[main_size_204+-1];
          main_size_204 <= main_size_204-1;
          main_pc <= main_pc + 1;
          case (main_pc)
            22: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:0575:<init>|  Btree.java:0672:<init>|  Btree.java:0671:Pop|  Btree.java:4149:test_splitLowButOne|  Btree.java:7114:newTests|  Btree.java:7120:main|");
                $fclose(f);
              end
            end
          endcase
          ...
          case (main_pc)
            23: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:0575:<init>|  Chip.java:0884:<init>|  Chip.java:0883:Copy|  Btree.java:0313:stuckGet|  Btree.java:4151:test_splitLowButOne|  Btree.java:7114:newTests|  Btree.java:7120:main|");
                $fclose(f);
              end
            end
          endcase
          ...
          case (main_pc)
            24: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:0575:<init>|  Btree.java:0324:<init>|  Btree.java:0323:stuckGet|  Btree.java:0314:stuckGet|  Btree.java:4151:test_splitLowButOne|  Btree.java:7114:newTests|  Btree.java:7120:main|");
                $fclose(f);
              end
            end
          endcase
          ...
          case (main_pc)
            29: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:0575:<init>|  Btree.java:0343:<init>|  Btree.java:0342:stuckGet|  Btree.java:0314:stuckGet|  Btree.java:4151:test_splitLowButOne|  Btree.java:7114:newTests|  Btree.java:7120:main|");
                $fclose(f);
              end
            end
          endcase
          ...
          case (main_pc)
            30: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:0575:<init>|  Chip.java:0884:<init>|  Chip.java:0883:Copy|  Btree.java:0313:stuckGet|  Btree.java:4152:test_splitLowButOne|  Btree.java:7114:newTests|  Btree.java:7120:main|");
                $fclose(f);
              end
            end
          endcase
          ...
          case (main_pc)
            31: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:0575:<init>|  Btree.java:0324:<init>|  Btree.java:0323:stuckGet|  Btree.java:0314:stuckGet|  Btree.java:4152:test_splitLowButOne|  Btree.java:7114:newTests|  Btree.java:7120:main|");
                $fclose(f);
              end
            end
          endcase
          ...
          case (main_pc)
            36: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:0575:<init>|  Btree.java:0343:<init>|  Btree.java:0342:stuckGet|  Btree.java:0314:stuckGet|  Btree.java:4152:test_splitLowButOne|  Btree.java:7114:newTests|  Btree.java:7120:main|");
                $fclose(f);
              end
            end
          endcase
        ...
        37: begin
          begin
            for(main_memory_index = 0; main_memory_index < 1; main_memory_index = main_memory_index + 1) begin
              main_Keys_222[main_memory_index] <= main_Keys_207[main_memory_index];
              main_Data_225[main_memory_index] <= main_Data_210[main_memory_index];
            end
          end
          main_size_219 <= 1;
          main_Data_225[1] <= main_Data_210[1];
          main_k_250 <= main_Keys_207[1];
          begin
            for(main_memory_index = 0; main_memory_index < 2; main_memory_index = main_memory_index + 1) begin
              main_Keys_207[main_memory_index] <= main_Keys_207[main_memory_index+2];
              main_Data_210[main_memory_index] <= main_Data_210[main_memory_index+2];
            end
          end
          main_size_204 <= 1;
          main_pc <= main_pc + 1;
          case (main_pc)
            37: begin
              begin
                integer f;
                f = $fopen("verilog/trace_verilog.txt", "a");
                $fdisplay(f, "Location: Chip.java:0575:<init>|  Btree.java:1415:<init>|  Btree.java:1414:splitLowButOne|  Btree.java:4154:test_splitLowButOne|  Btree.java:7114:newTests|  Btree.java:7120:main|");
                $fclose(f);
              end
            end
          endcase
  ...
  always @ (posedge clock) begin
    if (step < 0) begin
      ...
      begin
        for(stuckIsFree_memory_index = 1; stuckIsFree_memory_index < 8; stuckIsFree_memory_index = stuckIsFree_memory_index + 1) begin
  ...
  always @ (posedge clock) begin
    if (step < 0) begin
      ...
      begin
        for(freeNext_memory_index = 0; freeNext_memory_index < 7; freeNext_memory_index = freeNext_memory_index + 1) begin
      ...
      begin
        for(freeNext_memory_index = 7; freeNext_memory_index < 8; freeNext_memory_index = freeNext_memory_index + 1) begin
          freeNext_memory[freeNext_memory_index] <= -7+freeNext_memory_index;
        end
      end
    end
  ...
  always @ (posedge clock) begin
    if (step < 0) begin
      ...
      stuckKeys_memory[5] <= 1;
      stuckKeys_memory[6] <= 2;
      stuckKeys_memory[7] <= 3;
      stuckKeys_memory[8] <= 0;
      stuckKeys_memory[9] <= 1;
      stuckKeys_memory[10] <= 2;
      stuckKeys_memory[11] <= 3;
      begin
        for(stuckKeys_memory_index = 12; stuckKeys_memory_index < 32; stuckKeys_memory_index = stuckKeys_memory_index + 1) begin
  ...
  always @ (posedge clock) begin
    if (step < 0) begin
      ...
      stuckData_memory[5] <= 2;
      stuckData_memory[6] <= 3;
      stuckData_memory[7] <= 4;
      stuckData_memory[8] <= 1;
      stuckData_memory[9] <= 2;
      stuckData_memory[10] <= 3;
      stuckData_memory[11] <= 4;
      begin
        for(stuckData_memory_index = 12; stuckData_memory_index < 32; stuckData_memory_index = stuckData_memory_index + 1) begin
  ...
  task chipPrint;
    begin
      ...
      $fwrite(o, "    Process: %1d - %-21s instructions: %1d, pc: %1d, rc: %1d\n", 0, "main", 38, main_pc, main_returnCode);
      $fwrite(o, "      Registers :\n");
      ...
      $fwrite(o, "        %-50s = %1d\n",  "main_Left_248", main_Left_248);
      $fwrite(o, "        %-50s = %1d\n",  "main_Right_249", main_Right_249);
      $fwrite(o, "        %-50s = %1d\n",  "main_k_250", main_k_250);
      $fwrite(o, "        %-50s = %1d\n",  "main_d_251", main_d_251);
