...
module Btree(                                                                      // Test bench for database on a chip
  ...
  (* ram_style = "block" *)
  reg [1*1-1:0] stuckIsLeaf_memory[1024];
  (* nomem2reg *)
  ...
  reg[2-1:0] stuckIsLeaf_memory_value;
  always @ (posedge clock) begin
    if (reset) begin
      stuckIsLeaf_pc   <= 0;
      stuckIsLeaf_stop                 <= 0;
  ...
  (* ram_style = "block" *)
  reg [1*1-1:0] stuckIsFree_memory[1024];
  ...
  reg[2-1:0] stuckIsFree_memory_value;
  always @ (posedge clock) begin
    if (reset) begin
      stuckIsFree_pc   <= 0;
      stuckIsFree_stop                 <= 0;
  ...
  (* ram_style = "block" *)
  reg [11*1-1:0] freeNext_memory[1024];
  (* nomem2reg *)
  ...
  reg[12-1:0] freeNext_memory_value;
  always @ (posedge clock) begin
    if (reset) begin
      freeNext_pc      <= 0;
      freeNext_stop    <= 0;
        ...
        case(freeNext_pc)
          0: begin
            if ((freeNext_9_requestedAt > freeNext_9_finishedAt && freeNext_9_requestedAt != step)) begin
              ...
              begin
                for(freeNext_memory_index = 0; freeNext_memory_index < 1; freeNext_memory_index = freeNext_memory_index + 1) begin
                  freeNext_freeNext_12_result_0[freeNext_memory_index]             <= freeNext_memory[main_freeNext_12_index_187][freeNext_memory_index*11+:11];
                end
              end
  ...
  (* ram_style = "block" *)
  reg [5*1-1:0] stuckSize_memory[1024];
  (* nomem2reg *)
  ...
  reg[6-1:0] stuckSize_memory_value;
  always @ (posedge clock) begin
    if (reset) begin
      stuckSize_pc     <= 0;
      stuckSize_stop   <= 0;
        ...
        case(stuckSize_pc)
          0: begin
            if ((stuckSize_5_requestedAt > stuckSize_5_finishedAt && stuckSize_5_requestedAt != step)) begin
              begin
                for(stuckSize_memory_index = 0; stuckSize_memory_index < 1; stuckSize_memory_index = stuckSize_memory_index + 1) begin
                  stuckSize_stuckSize_5_result_0[stuckSize_memory_index]           <= stuckSize_memory[main_stuckSize_5_index_14][stuckSize_memory_index*5+:5];
                end
              end
  ...
  (* ram_style = "block" *)
  reg [32*16-1:0] stuckKeys_memory[1024];
  (* nomem2reg *)
  ...
  reg[33-1:0] stuckKeys_memory_value;
  always @ (posedge clock) begin
    if (reset) begin
      stuckKeys_pc     <= 0;
      stuckKeys_stop   <= 0;
        ...
        case(stuckKeys_pc)
          0: begin
            if ((stuckKeys_1_requestedAt > stuckKeys_1_finishedAt && stuckKeys_1_requestedAt != step)) begin
              begin
                for(stuckKeys_memory_index = 0; stuckKeys_memory_index < 16; stuckKeys_memory_index = stuckKeys_memory_index + 1) begin
                  stuckKeys_stuckKeys_1_result_0[stuckKeys_memory_index]           <= stuckKeys_memory[main_stuckKeys_1_index_8][stuckKeys_memory_index*32+:32];
                end
              end
              stuckKeys_1_finishedAt           <= step;
            end
            else if ((stuckKeys_2_requestedAt > stuckKeys_2_finishedAt && stuckKeys_2_requestedAt != step)) begin
              stuckKeys_memory[main_stuckKeys_2_index_9]       <= {main_stuckKeys_2_value_10[15], main_stuckKeys_2_value_10[14], main_stuckKeys_2_value_10[13], main_stuckKeys_2_value_10[12], main_stuckKeys_2_value_10[11], main_stuckKeys_2_value_10[10], main_stuckKeys_2_value_10[9], main_stuckKeys_2_value_10[8], main_stuckKeys_2_value_10[7], main_stuckKeys_2_value_10[6], main_stuckKeys_2_value_10[5], main_stuckKeys_2_value_10[4], main_stuckKeys_2_value_10[3], main_stuckKeys_2_value_10[2], main_stuckKeys_2_value_10[1], main_stuckKeys_2_value_10[0]};
  ...
  (* ram_style = "block" *)
  reg [32*16-1:0] stuckData_memory[1024];
  (* nomem2reg *)
  ...
  reg[33-1:0] stuckData_memory_value;
  always @ (posedge clock) begin
    if (reset) begin
      stuckData_pc     <= 0;
      stuckData_stop   <= 0;
        ...
        case(stuckData_pc)
          0: begin
            if ((stuckData_3_requestedAt > stuckData_3_finishedAt && stuckData_3_requestedAt != step)) begin
              begin
                for(stuckData_memory_index = 0; stuckData_memory_index < 16; stuckData_memory_index = stuckData_memory_index + 1) begin
                  stuckData_stuckData_3_result_0[stuckData_memory_index]           <= stuckData_memory[main_stuckData_3_index_11][stuckData_memory_index*32+:32];
                end
              end
              stuckData_3_finishedAt           <= step;
            end
            else if ((stuckData_4_requestedAt > stuckData_4_finishedAt && stuckData_4_requestedAt != step)) begin
              stuckData_memory[main_stuckData_4_index_12]      <= {main_stuckData_4_value_13[15], main_stuckData_4_value_13[14], main_stuckData_4_value_13[13], main_stuckData_4_value_13[12], main_stuckData_4_value_13[11], main_stuckData_4_value_13[10], main_stuckData_4_value_13[9], main_stuckData_4_value_13[8], main_stuckData_4_value_13[7], main_stuckData_4_value_13[6], main_stuckData_4_value_13[5], main_stuckData_4_value_13[4], main_stuckData_4_value_13[3], main_stuckData_4_value_13[2], main_stuckData_4_value_13[1], main_stuckData_4_value_13[0]};
  ...
  (* ram_style = "block" *)
  reg [11*1-1:0] stucksUsed_memory[1];
  (* nomem2reg *)
  ...
  reg[12-1:0] stucksUsed_memory_value;
  always @ (posedge clock) begin
    if (reset) begin
      stucksUsed_pc    <= 0;
      stucksUsed_stop  <= 0;
        ...
        case(stucksUsed_pc)
          0: begin
            if ((stucksUsed_11_requestedAt > stucksUsed_11_finishedAt && stucksUsed_11_requestedAt != step)) begin
              ...
              begin
                for(stucksUsed_memory_index = 0; stucksUsed_memory_index < 1; stucksUsed_memory_index = stucksUsed_memory_index + 1) begin
                  stucksUsed_stucksUsed_13_result_0[stucksUsed_memory_index]       <= stucksUsed_memory[main_stucksUsed_13_index_188][stucksUsed_memory_index*11+:11];
                end
              end
