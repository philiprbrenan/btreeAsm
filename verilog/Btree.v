...
module Btree(                                                                      // Test bench for database on a chip
  ...
  reg [11-1:0] main_size_154;
  reg [1-1:0] main_isLeaf_155;
  reg [11-1:0] main_nextFree_156;
  (* nomem2reg *)
  reg [32-1:0] main_Keys_157[1024];
  (* nomem2reg *)
  reg [1-1:0] main_Compares_158[1024];
  (* nomem2reg *)
  reg [11-1:0] main_Collapse_159[1024];
  (* nomem2reg *)
  reg [32-1:0] main_Data_160[1024];
  ...
  reg [11-1:0] main_StuckIndex_166;
      ...
      case(main_pc)
        ...
        15, 29: begin
          for(main_memory_index = 0; main_memory_index < 1008; main_memory_index = main_memory_index+32) begin
            if (main_Compares_158[main_memory_index+16]) begin
                main_Compares_158[main_memory_index] <= 1;
                main_Collapse_159[main_memory_index] <= main_Collapse_159[main_memory_index+16];
            end
          end
          main_pc <= main_pc + 1;
        end
        16, 30: begin
          for(main_memory_index = 0; main_memory_index < 992; main_memory_index = main_memory_index+64) begin
            if (main_Compares_158[main_memory_index+32]) begin
                main_Compares_158[main_memory_index] <= 1;
                main_Collapse_159[main_memory_index] <= main_Collapse_159[main_memory_index+32];
            end
          end
          main_pc <= main_pc + 1;
        end
        17, 31: begin
          for(main_memory_index = 0; main_memory_index < 960; main_memory_index = main_memory_index+128) begin
            if (main_Compares_158[main_memory_index+64]) begin
                main_Compares_158[main_memory_index] <= 1;
                main_Collapse_159[main_memory_index] <= main_Collapse_159[main_memory_index+64];
            end
          end
          main_pc <= main_pc + 1;
        end
        18, 32: begin
          for(main_memory_index = 0; main_memory_index < 896; main_memory_index = main_memory_index+256) begin
            if (main_Compares_158[main_memory_index+128]) begin
                main_Compares_158[main_memory_index] <= 1;
                main_Collapse_159[main_memory_index] <= main_Collapse_159[main_memory_index+128];
            end
          end
          main_pc <= main_pc + 1;
        end
        19, 33: begin
          for(main_memory_index = 0; main_memory_index < 768; main_memory_index = main_memory_index+512) begin
            if (main_Compares_158[main_memory_index+256]) begin
                main_Compares_158[main_memory_index] <= 1;
                main_Collapse_159[main_memory_index] <= main_Collapse_159[main_memory_index+256];
            end
          end
          main_pc <= main_pc + 1;
        end
        20, 34: begin
          for(main_memory_index = 0; main_memory_index < 512; main_memory_index = main_memory_index+1024) begin
            if (main_Compares_158[main_memory_index+512]) begin
                main_Compares_158[main_memory_index] <= 1;
                main_Collapse_159[main_memory_index] <= main_Collapse_159[main_memory_index+512];
            end
          end
          main_pc <= main_pc + 1;
        end
