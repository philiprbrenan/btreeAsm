...
if __name__ == "__main__":
  chip = Chip('Test')                                                             # Create chip object.  The name is used to create the summary and mask image file
...
# chip.set('option', 'loglevel', 'error')                                       # Warnings and above
  ...
  chip.input('verilog/Test.v')                                                              # Source code
# chip.input('/home/azureuser/btreeBlock/verilog/$project/$instance/siliconCompiler/memory.v'   ) # Memory black box
  chip.input('verilog/Test.sdc')                                                              # Synopsys design constraints file
  chip.set('design', 'Test')                                                      # Show the top most module
