...
CD_WORK="/workspace/verilog/build/A/job0/cts.fillcell/0"
PRINT=""
CMDPREFIX=""
SKIPEXPORT=0
DONODE=0
...
case $PRINT in
    ...
    "directory")
        ...
        ;;
    "command")
        echo "openroad /app/sc/lib/python3.10/site-packages/siliconcompiler/tools/openroad/scripts/apr/sc_fillercell_insertion.tcl -no_init -metrics reports/metrics.json -exit"
        exit 0
        ;;
esac
...
$CMDPREFIX \
openroad \
  /app/sc/lib/python3.10/site-packages/siliconcompiler/tools/openroad/scripts/apr/sc_fillercell_insertion.tcl \
  -no_init \
